...
export const DECISION_CASES: DecisionCase[] = [
  ...
  },
  {
    ...
    subtitle: 'Navigate cascading supply chain disruptions',
    description: 'A major supplier just reported terrible earnings. Your stocks that depend on this supplier are about to feel the impact. How do you manage supply chain risk?',
    difficulty: 'Advanced',
    color: '#F97316',
    durationMinutes: 15,
    learningGoals: ['Understand supply chain relationships', 'Anticipate cascade effects', 'Use supply chain data for edge'],
    scenarioId: null,
    decisions: [
      {
        triggerDay: 0,
        title: 'Supplier Reports Bad Earnings',
        situation: 'One of your portfolio stocks\' key supplier just missed earnings by 30%. The news hasn\'t fully hit your stock yet, but supply chain events typically cascade in 1-3 days. Your stock is currently flat.',
        choices: [
          { id: 'sell_immediately', label: 'Sell before the cascade hits', description: 'Front-run the supply chain impact.', isRecommended: false, explanation: 'Selling purely on supplier news can work, but you might be wrong — supply chains are complex. If the company has multiple suppliers, the impact may be minimal.' },
          { id: 'hedge', label: 'Reduce position to half, keep some exposure', description: 'Risk management: reduce but don\'t exit.', isRecommended: true, explanation: 'Smart risk management. You\'re acknowledging the supply chain risk while not panicking. If the cascade is severe, you\'re only half exposed. If it\'s mild, you still benefit from recovery.' },
          { id: 'buy_competitor', label: 'Buy the supplier\'s competitor', description: 'Supply chain disruption = opportunity for rivals.', isRecommended: false, explanation: 'This is a more advanced play. If supplier A fails, companies might switch to supplier B — boosting B\'s revenue. This works but requires knowing the supply chain map well.' },
          { id: 'do_nothing', label: 'Wait and see', description: 'Maybe the impact won\'t be that bad.', isRecommended: false, explanation: 'Waiting is sometimes correct, but when you have clear information about supply chain risks, inaction is a choice too. At minimum, you should have a plan for if it does cascade.' },
        ],
        glossaryTerms: ['Supply Chain', 'Cascade', 'Risk Management'],
      },
    ],
    summary: 'Supply chain analysis is one of the most underrated edges in trading. When a supplier stumbles, customers feel it 1-5 days later. The key insight: watch the supply chain data in the Company Profile tab. If you see a supplier in trouble, reduce exposure to its customers BEFORE the cascade headline hits.',
  },
  {
    id: 'insider_signals',
    name: 'Reading Insider Activity',
    subtitle: 'Learn to interpret SEC filings and insider trades',
    description: 'Several executives at a company in your watchlist have been selling shares. Is this a warning sign, or routine portfolio diversification?',
    difficulty: 'Intermediate',
    color: '#8B5CF6',
    durationMinutes: 10,
    learningGoals: ['Interpret insider selling signals', 'Distinguish routine from suspicious activity', 'Time trades around insider activity'],
    scenarioId: null,
    decisions: [
      {
        triggerDay: 0,
        title: 'Executives Are Selling',
        situation: 'You notice a news event: "SEC FILING: CEO sells $5M in shares ahead of Q3 earnings." The stock is currently flat. Earnings are in 5 days. What do you do?',
        choices: [
          { id: 'follow_insider', label: 'Sell your position — insiders know more than you', description: 'If they\'re selling, something\'s wrong.', isRecommended: false, explanation: 'Following insider selling is a valid strategy, but not all insider sells are bearish. Executives sell for personal reasons too (house, taxes, diversification). The key is the PATTERN — multiple executives selling large amounts before earnings is a stronger signal than one person selling.' },
          { id: 'reduce', label: 'Reduce position and set a stop loss', description: 'Cautious approach: lower exposure but stay invested.', isRecommended: true, explanation: 'Good risk management. The insider selling is a yellow flag, not a red one. Reducing position and setting a stop loss protects your downside while keeping upside if earnings are actually fine. This is professional-grade thinking.' },
          { id: 'ignore', label: 'Ignore it — insiders sell for lots of reasons', description: 'Don\'t read too much into one SEC filing.', isRecommended: false, explanation: 'True that insiders sell for many reasons, but completely ignoring the signal is leaving information on the table. At minimum, you should tighten your stop loss when insiders are selling before earnings.' },
        ],
        glossaryTerms: ['Insider Trading', 'SEC Filing', 'Stop Loss'],
      },
    ],
    summary: 'Insider activity is one of the few legal information advantages available to all investors. When multiple executives sell large amounts before earnings, that\'s a strong bearish signal. One person selling a small amount? Probably nothing. The key is to look for CLUSTERS of insider selling — multiple people, large amounts, close to earnings. StockSim shows these as SEC FILING events in the news feed.',
  },
  {
    id: 'seasonal_trading',
    name: 'Seasonal Patterns',
    subtitle: 'Trade with the calendar, not against it',
    description: 'The market has well-documented calendar patterns that repeat year after year. Learn to use them as an edge.',
    difficulty: 'Intermediate',
    color: '#06B6D4',
    durationMinutes: 10,
    learningGoals: ['Understand the January Effect', 'Know the "Sell in May" pattern', 'Recognize Triple Witching days'],
    scenarioId: null,
    decisions: [
      {
        triggerDay: 0,
        title: 'It\'s Late April',
        situation: 'Your portfolio is up 12% year-to-date. You\'re reading about the "Sell in May and go away" pattern — historically, markets underperform from May to October. Should you adjust your portfolio?',
        choices: [
          { id: 'sell_all', label: 'Sell everything and go to cash until November', description: 'Follow the pattern literally.', isRecommended: false, explanation: 'While "Sell in May" has historical basis, going 100% cash means missing any summer rallies and paying capital gains tax on all sales. The pattern is a tendency, not a rule. Some of the best months in history have been May-October.' },
          { id: 'rotate', label: 'Rotate into defensive sectors (Utilities, Healthcare)', description: 'Stay invested but shift to safer names.', isRecommended: true, explanation: 'This is the professional approach. You\'re acknowledging the seasonal pattern without abandoning the market. Defensive sectors tend to outperform in weak months, and you stay invested for any surprise rallies.' },
          { id: 'ignore', label: 'Ignore seasonal patterns entirely', description: 'Past patterns don\'t predict the future.', isRecommended: false, explanation: 'While no pattern is guaranteed, dismissing well-documented seasonal tendencies ignores useful information. You don\'t have to trade on them, but you should be aware of them. Knowledge is never a disadvantage.' },
        ],
        glossaryTerms: ['Seasonality', 'Sector Rotation', 'Defensive Stocks'],
      },
    ],
    summary: 'Seasonal patterns are real tendencies, not guaranteed predictions. The January Effect, "Sell in May", October Volatility, and the Q4 Holiday Rally all have statistical backing. The smartest approach: don\'t bet your portfolio on them, but factor them into your existing strategy. Rotate into defensive names during weak seasons, and be more aggressive during historically strong months.',
  },
  {
    id: 'election_trading',
    name: 'Election Year Trading',
    subtitle: 'Navigate political uncertainty and sector shifts',
    description: 'An election is approaching and markets are getting volatile. Different candidates mean different winners and losers among sectors.',
    difficulty: 'Advanced',
    color: '#DC2626',
    durationMinutes: 12,
    learningGoals: ['Understand election market impact', 'Position for sector rotation', 'Manage political uncertainty'],
    scenarioId: null,
    decisions: [
      {
        triggerDay: 0,
        title: 'Election Season',
        situation: 'An election is 2 months away. Polls show a tight race between a pro-business candidate (favoring Energy, Financials) and a progressive candidate (favoring Healthcare, Utilities). How do you position?',
        choices: [
          { id: 'bet_on_winner', label: 'Load up on sectors favored by the likely winner', description: 'Polls show candidate X ahead.', isRecommended: false, explanation: 'Political betting is risky — polls are often wrong, and markets have already priced in expectations. If you\'re wrong, you\'ll take a big loss when sectors rotate on election night.' },
          { id: 'diversify', label: 'Spread across both candidates\' favored sectors', description: 'Diversify your political risk.', isRecommended: true, explanation: 'The professional approach. By owning sectors that benefit from BOTH outcomes, you reduce your election risk. Some sectors (Technology, Consumer Goods) tend to do well regardless of who wins. Focus on those.' },
          { id: 'go_cash', label: 'Go to cash until after the election', description: 'Remove uncertainty entirely.', isRecommended: false, explanation: 'Going to cash avoids the downside but also misses the rally that typically follows election certainty. Markets hate uncertainty — once it\'s resolved (either way), stocks usually rally. Being in cash means missing that move.' },
        ],
        glossaryTerms: ['Election Cycle', 'Sector Rotation', 'Political Risk'],
      },
    ],
    summary: 'Elections create opportunities, not just risks. The key insight: markets move on CERTAINTY, not on which candidate wins. The worst period is pre-election uncertainty. Post-election, regardless of outcome, markets typically rally as uncertainty resolves. Position for this pattern: stay invested, diversify across political outcomes, and be ready to add exposure once results are known.',
  },
];
